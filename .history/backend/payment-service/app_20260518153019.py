...
def create_payment():
    try:
        ...
        if not amount:
            return jsonify({"error": "Thiếu amount"}), 400
...
# ==========================================
# GET PAYMENT BY ORDER ID  ← n8n gọi cái này
# ==========================================
...
def get_payment_by_order(order_id):
    try:
        ...
        print("❌ GET PAYMENT BY ORDER ERROR:", str(e))
        return jsonify({"error": str(e)}), 500
...
# ==========================================
@app.route("/api/payments/update-status/<int:payment_id>", methods=["PUT"])
