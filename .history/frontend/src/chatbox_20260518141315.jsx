    ...
    >
      ...
      {order.total_amount != null && (
        ...
        >
          ...
          <span style={{ fontWeight: 700, color: "#185FA5" }}>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {p.specs && Object.keys(p.specs).length > 0 && (
                            <div className="grid grid-cols-2 gap-1 mb-2">
                              {Object.entries(p.specs).map(([key, val]) => (
                                <div
                                  key={key}
                                  className="bg-gray-50 rounded px-1.5 py-0.5"
                                >
                                  <span className="text-gray-400 text-[10px] block">
                                    {key}
                                  </span>
                                  <span className="text-gray-700 text-[11px] font-medium truncate block">
                                    {val}
                                  </span>
                                </div>
                              ))}
                          ...
                          <div className="flex items-center justify-between">
                            <span
                              className={`text-xs font-medium ${p.in_stock ? "text-green-600" : "text-red-500"}`}
                            >
